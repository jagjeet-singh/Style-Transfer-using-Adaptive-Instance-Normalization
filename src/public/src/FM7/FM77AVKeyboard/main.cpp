...
private:
	...
	void UpdateIRToyErrorCode(CheapGUI::Text *textPtr,int irToyError,int prevIRToyError);
};
...
void FM77AVKeyboardEmulatorMain::UpdateGUI(void)
{
	...
	UpdateIRToyErrorCode(errorText,irToyError,prevIRToyError);
...
void FM77AVKeyboardEmulatorMain::UpdateIRToyErrorCode(CheapGUI::Text *textPtr,int irToyError,int prevIRToyError)
{
	if(irToyError!=prevIRToyError)
	{
		switch(irToyError)
		{
